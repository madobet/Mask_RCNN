...
# https://github.com/moganesyan/tensorflow_model_deployment/blob/master/tf_serving/export_config.py
class ExportConfig(object):
    # model name
    MODEL_NAME = "mrcnn_coco"

    # path to the mask r-cnn v1 source code
    MRCNN_DIR = os.path.abspath('../v1/')
    COCO_DIR = os.path.abspath('../v1/samples/')

    # keras model path
    KERAS_MODEL_DIR = os.path.abspath('../keras_model/')

    # keras model weights path
    KERAS_WEIGHTS_PATH = os.path.abspath('../keras_model/mask_rcnn_coco.h5')
...
def get_model_config():
    """Returns the MS-COCO style inference config
